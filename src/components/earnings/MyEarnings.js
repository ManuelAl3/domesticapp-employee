...
export default function MyEarnings() {
  ...
  const textChart = dataChart + "\n" + "COP";
  return (
    <ScrollView
      style={{ marginHorizontal: 18, backgroundColor: Colors.backgroundMain }}
    >
      <SafeAreaView style={styles.container}>
        <View style={styles.containerHorizontal}>
          <View style={{ width: "57%" }}>
            <Text style={styles.titleStyle}>Juana Hernandez</Text>
            <Text style={styles.textSubtitle}>Empleada Domestica</Text>
            <View>
              <View style={styles.containerHorizontal}>
                <View
                  style={[styles.containerHorizontal, styles.containerTextIcon]}
                >
                  <Image
                    style={{ width: 16, height: 16, marginRight: 10 }}
                    source={IconPlanet}
                  />
                  <Text style={styles.textIcon}>Colombia</Text>
                </View>
                <View
                  style={[styles.containerHorizontal, styles.containerTextIcon]}
                >
                  <Image
                    ...
                    source={IconCard}
                  />
                  <Text style={styles.textIcon}>ID: 56GH5TY</Text>
                </View>
              </View>
              <View style={styles.containerText}>
                <Text style={styles.textStyle}>
                  Este es un estimado de tus ganancias brutas (luego del pago de
                  aportaciones sociales y de ley). Recuerda que estas pueden
                  variar según diversas eventualidades
                </Text>
              </View>
            </View>
          </View>
        ...
        <View style={styles.divider}>
          <Image style={{ width: 350, height: 3 }} source={RectangleDivider} />
        </View>
        <View>
          <View style={styles.title}>
            <Text
              style={[styles.titleStyle, { marginBottom: 20, marginRight: 20 }]}
            >
              Registro
            </Text>
          </View>
          <View>
            {dataList.map((item, index) => (
              <View key={index} style={styles.containerHorizontal}>
                <View
                  style={{ width: 16, height: 16, backgroundColor: "#AA2323" }}
                ></View>
        ...
        >
          ...
          >
            ...
            >
              ...
              <View style={{ alignItems: "center" }}>
                <Progress.Bar progress={0.3} width={80} />
                <Text style={styles.progressText}>48/100 Medias Jornada</Text>
              </View>
            </View>
            <View
              style={{
            ...
            >
              ...
              <View>
                <CircularProgress
                  ...
                  activeStrokeWidth={40}
                />
                <Text style={styles.progressText}>Auxilios de Transporte</Text>
              </View>
            </View>
          </View>
        </View>
