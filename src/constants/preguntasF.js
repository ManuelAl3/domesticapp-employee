...
export const CategoriasPreguntas = [
  {
    ...
    preguntas: [
      {
        id: 1,
        pregunta: "2.1.1 ¿Cómo se calculan mis ganancias estimadas?",
        respuesta:
    ...
    preguntas: [
      {
        ...
        respuesta:
          "Los cortes de nomina se realizan de forma " +
      ...
      },
      {
        ...
        respuesta:
          "Domesticapp cumple las normativas locales e " +
    ...
    preguntas: [
      {
        ...
        respuesta:
          "Debe radicar la solicitud por escrito, pidiendo el " +
      ...
      },
      {
        ...
        pregunta:
          ...
          "nomina?",
        respuesta:
          "Domesticapp realiza los descuentos y " +
    ...
    preguntas: [
      {
        ...
        respuesta:
          "Tenemos un compromiso inmodificable con la " +
      ...
      },
      {
        ...
        pregunta:
          ...
          "Domesticapp?",
        respuesta:
          "Usted debe acatar todos los protocolos de " +
    ...
    preguntas: [
      {
        ...
        respuesta:
          "Cada servicio cuenta con unas especificaciones " +
