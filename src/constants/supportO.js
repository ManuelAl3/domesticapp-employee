...
import Help from "../assets/Support/Help.svg";
...
export const supportOptions = [
  ...
  { id: 2, nombre: "Necesitas ayuda con tu último servicio?", img: Help, ruta: "Help" },
  { id: 3, nombre: "Tienes alguna duda?", img: Faqs, ruta: "Faqs" },
  { id: 4, nombre: "Notificaciones", img: Notify, ruta: "Notification" },
  { id: 5, nombre: "Daño en el Servicio o Accidentes Laborales", img: Damagee, ruta: "ServiceD" },
];
